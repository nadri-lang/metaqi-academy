  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        {/* Calculator hint + concept explanation */}
        <View style={styles.introCard}>
          <Text style={styles.introText}>
            {t('bazi.calculator_hint_prefix')}
            <Text
              testID="bazi-calculator-link"
              style={styles.introLink}
              onPress={() => router.push('/calculator/bazi')}
            >
              {t('bazi.calculator_hint_link')}
            </Text>
            .
          </Text>
          <Text style={styles.introDescription}>{t('bazi.description_bazi')}</Text>
        </View>
